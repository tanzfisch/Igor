...
namespace Igor
{
    ...
    */
	...
	public:
		...
		virtual void drawButton(int32 posx, int32 posy, int32 width, int32 height, iaString text, iHorrizontalAlignment align, iVerticalAlignment valign, shared_ptr<iTexture> texture, iWidgetAppearanceState state, bool active) = 0;
		virtual void drawGroupBox(int32 posx, int32 posy, int32 width, int32 height, iaString text, iWidgetAppearanceState state, bool active) = 0;
