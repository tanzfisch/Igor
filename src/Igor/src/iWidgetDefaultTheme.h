...
namespace Igor
{
    ...
    */
    ...
    public:
        ...
        void drawButton(int32 posx, int32 posy, int32 width, int32 height, iaString text, iHorrizontalAlignment align, iVerticalAlignment valign, shared_ptr<iTexture> texture, iWidgetAppearanceState state, bool active);
        void drawGroupBox(int32 posx, int32 posy, int32 width, int32 height, iaString text, iWidgetAppearanceState state, bool active);
	...
	private:
        ...
        */
		...
		void drawButtonText(int32 posx, int32 posy, iaString text);
