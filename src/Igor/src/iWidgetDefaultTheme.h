...
namespace Igor
{
    ...
    */
    ...
    public:
        ...
        void drawTextEdit(const iRectanglei& rect, const iaString& text, const uint32 cursorPos, iHorizontalAlignment align, iVerticalAlignment valign, bool keyboardFocus, iWidgetAppearanceState state, bool active);
