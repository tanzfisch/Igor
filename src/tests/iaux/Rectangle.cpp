...
IAUX_TEST(RectangleTests, Constructor1F)
{
	iaRectanglef rectangle;
...
IAUX_TEST(RectangleTests, Constructor2F)
{
	iaRectanglef rectangle(1, 2);
...
IAUX_TEST(RectangleTests, Constructor3F)
{
	iaRectanglef rectangle(1, 2, 3, 4);
...
IAUX_TEST(RectangleTests, Constructor4F)
{
	iaRectanglef rectangle(iaVector2f(1, 2), iaVector2f(3, 4));
...
IAUX_TEST(RectangleTests, CopyConstructorF)
{
	iaRectanglef rectangle1(iaVector2f(1, 2), iaVector2f(3, 4));
	iaRectanglef rectangle2(rectangle1);
...
IAUX_TEST(RectangleTests, AdjustF)
{
	iaRectanglef rectangle(10, 20, 30, 40);
...
IAUX_TEST(RectangleTests, GetterF)
{
	iaRectanglef rectangle(10, 20, 30, 40);
	...
	IAUX_EXPECT_EQUAL(rectangle.getCenter(), iaVector2f(25, 40));
	IAUX_EXPECT_EQUAL(rectangle.getTopLeft(), iaVector2f(10, 20));
	IAUX_EXPECT_EQUAL(rectangle.getTopRight(), iaVector2f(10 + 30, 20));
	IAUX_EXPECT_EQUAL(rectangle.getBottomLeft(), iaVector2f(10, 20 + 40));
	IAUX_EXPECT_EQUAL(rectangle.getBottomRight(), iaVector2f(10 + 30, 20 + 40));
}

IAUX_TEST(RectangleTests, SetCenterF)
{
	iaRectanglef rectangle(10, 20, 30, 40);

	rectangle.setCenter(33, 44);

	IAUX_EXPECT_EQUAL(rectangle.getCenter(), iaVector2f(33, 44));
	IAUX_EXPECT_EQUAL(rectangle.getX(), 18);
	IAUX_EXPECT_EQUAL(rectangle.getY(), 24);
	IAUX_EXPECT_EQUAL(rectangle.getWidth(), 30);
	IAUX_EXPECT_EQUAL(rectangle.getHeight(), 40);

	rectangle.setCenter(iaVector2f(133, 144));

	IAUX_EXPECT_EQUAL(rectangle.getCenter(), iaVector2f(133, 144));
	IAUX_EXPECT_EQUAL(rectangle.getX(), 118);
	IAUX_EXPECT_EQUAL(rectangle.getY(), 124);
	IAUX_EXPECT_EQUAL(rectangle.getWidth(), 30);
	IAUX_EXPECT_EQUAL(rectangle.getHeight(), 40);
...
IAUX_TEST(RectangleTests, SetterF)
{
	iaRectanglef rectangle;
...
IAUX_TEST(RectangleTests, AssignmentOperatorF)
{
	iaRectanglef rectangle1(iaVector2f(1, 2), iaVector2f(3, 4));
	iaRectanglef rectangle2 = rectangle1;
...
IAUX_TEST(RectangleTests, CompareRectanglesF)
{
	iaRectanglef rectangle1(1,2,3,4);
	iaRectanglef rectangle2(1,2,3,4);
	iaRectanglef rectangle3(6,9,4,2);
