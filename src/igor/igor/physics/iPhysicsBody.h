...
#ifndef __IGOR_PHYSICSBODY__
#define __IGOR_PHYSICSBODY__
...
namespace igor
{
    ...
    */
    IGOR_SIGNAL(iApplyForceAndTorqueEvent, iApplyForceAndTorqueDelegate, (iPhysicsBody * body, float32 timestep), (body, timestep));
