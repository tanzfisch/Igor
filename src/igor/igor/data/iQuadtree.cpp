...
namespace igor
{
    ...
    void iQuadtree::insertInternal(const std::unique_ptr<Node> &node, iUserData userData, const iaVector2d &pos)
    {
        ...
        {
            node->_userData.push_back(UserDataSet(pos, userData));
            return;
        }
