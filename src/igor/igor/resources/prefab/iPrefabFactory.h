...
#ifndef IGOR_PREFAB_FACTORY_H
#define IGOR_PREFAB_FACTORY_H
...
namespace igor
{
    ...
    /*! this factory creates prefab resources
     */
    class iPrefabFactory : public iFactory
    {
