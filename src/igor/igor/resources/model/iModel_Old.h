...
#ifndef __IGOR_MODEL_OLD__
#define __IGOR_MODEL_OLD__
    ...
    */
    ...
    private:
        ...
        */
        ...
        \param 
		*/
        iModel_Old(const iaString &name, iResourceCacheMode cacheMode, iModelDataInputParameterPtr parameter = iModelDataInputParameterPtr());
    };

    /*! definition of model pointer
	*/
    typedef std::shared_ptr<iModel_Old> iModel_OldPtr;
