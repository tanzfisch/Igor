...
#ifndef IGOR_SCRIPT_FACTORY_H
#define IGOR_SCRIPT_FACTORY_H
...
namespace igor
{
    ...
    /*! this factory creates script resources
     */
    class iScriptFactory : public iFactory
    {
