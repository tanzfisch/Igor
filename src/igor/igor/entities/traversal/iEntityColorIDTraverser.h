...
#ifndef IGOR_ENTITY_COLORID_TRAVERSER_H
#define IGOR_ENTITY_COLORID_TRAVERSER_H
...
namespace igor
{
    ...
    /*! entity id to color id render traverser
     */
    class iEntityColorIDTraverser : public iEntityTraverser
    {

    public:
        /*! does nothing
         */
        iEntityColorIDTraverser() = default;

        /*! does nothing
         */
        ~iEntityColorIDTraverser() = default;

        /*! maps color id to entity id

        \param colorID 32 bit color id
        \returns entity id (64 bit) - yes this is not ideal
        */
        iEntityID getEntityID(uint32 colorID);
    ...
    private:      
        ...
        */
        ...
        std::unordered_map<uint32, iEntityID> _idMap;

    };

}; // namespace igor

#endif // IGOR_ENTITY_COLORID_TRAVERSER_H