...
#ifndef IGOR_RENDER_ENGINE_OLD_H
#define IGOR_RENDER_ENGINE_OLD_H
...
namespace igor
{
    ...
    \deprecated will be removed once the engine is all entity driven
     */
    class IGOR_API iRenderEngineOld
    {
    public:
        /*! does nothing
        */
...
#endif // IGOR_RENDER_ENGINE_OLD_H