...
namespace igor
{
	...
	*/
	iaEVENT(iKeyDownSpecificEvent, iKeyDownSpecificDelegate, (), ());

	/*! key up event

    will be called for a specific single key
    */
	iaEVENT(iKeyUpSpecificEvent, iKeyUpSpecificDelegate, (), ());

	/*! key down event ext

	will be called for every key
	*/
	iaEVENT(iKeyDownEvent, iKeyDownDelegate, (iKeyCode key), (key));

	/*! key up event ext

	will be called for every key
	*/
	iaEVENT(iKeyUpEvent, iKeyUpDelegate, (iKeyCode key), (key));
