...
#include <igor/graphics/terrain/operations/iVoxelOperation.h>
...
namespace Igor
{
    ...
    */
    class iVoxelOperationBox : public iVoxelOperation
    {
    ...
    private:
        /*! bounding box that defines wich area to set the new value
        */
        iAABoxI _box;
