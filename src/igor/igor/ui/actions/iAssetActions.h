...
#ifndef IGOR_ASSET_ACTIONS_H
#define IGOR_ASSET_ACTIONS_H
...
namespace igor
{
    ...
    /*! create scene
     */
    class iActionCreateScene : public iAction
    {
    ...
    /*! create scene
     */
    class iActionCreateMaterial : public iAction
    {

    public:
        /*! init members
         */
        iActionCreateMaterial();
